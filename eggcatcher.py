...
score = 0
score_text = c.create_text(10,10,anchor='nw',font=('Arial',13,'bold'),fill='grey',text='Score : '+str(score))

lives_remaining = 3
lives_text = c.create_text(canvas_width-10,10,anchor='ne',font=('Arial',13,'bold'),fill='black',text='Lives : '+str(lives_remaining))
